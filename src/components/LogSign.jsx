...
const LogSign = () => {
  return (
              ...
              <div class="g-0 lg:flex lg:flex-wrap">
                ...
                <div class="px-4 md:px-0 lg:w-6/12 absolute shadow-lg border-2      ">
                  <div class="md:mx-6 md:p-12">
                    ...
                    <form>
                      <p class="mb-4 text-neutral-600 text-xl font-medium">
                        Please login to your account
                      </p>
                      <div class="flex flex-row items-center justify-center text-xl lg:justify-start m-3">
                        <p class="mb-0 mr-4 text-lg">Login with</p>
                      ...
                      <div class="mb-12 pb-1 pt-1 text-center">
                        <button
                          class="mb-3 bg-[#00B4E8] inline-block w-full rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_rgba(0,0,0,0.2)] transition duration-150 ease-in-out hover:shadow-[0_10px_11px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:shadow-[0_10px_10px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:outline-none focus:ring-0 active:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)]"
                          type="button"
                          data-te-ripple-init
                          data-te-ripple-color="light"
                        >
                ...
                {/* <div class="flex items-center rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none ">
                  <div class="px-1 py-1 text-white ">
    ...
    //   <div className="flex-1 w-50 bg-red-800"></div>
    //   <div className="flex-1 w-50 bg-red-500"> </div>
    // </section>
  );
};
