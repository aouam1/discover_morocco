      ...
      <div class="container h-full px-6 py-24 ">
        <div class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between  ">
          ...
          <div class="md:w-8/12 lg:ml-6 lg:w-5/12  ">
            <form className=" rounded-xl p-6 box-border shadow-2xl border-2">
              {/* <!-- Email input --> */}
              <div class="relative mb-6" data-te-input-wrapper-init>
                ...
                <label
                  ...
                  class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-[#3B71CA] peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-400 dark:peer-focus:text-[#3B71CA]"
                >
                  Full Name
                </label>
              </div>
...
"
              ...
              <div class="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300">
                <p class="mx-4 mb-0 text-center font-semibold text-neutral-600">
                  OR
                </p>
              </div>
